...
import { Slider, AiStage, SliderSuggestion, TerraformConfig, TerraformTarget, ControlConfig, SoundConfig, Modulation, CameraData, ViewMode, ShipConfig, ShipModulation, PlayerRole, PrisonerStatus, RolePlayState } from '../types';
...
export interface AppContextType {
  ...
  toggleHide: () => void;
  refuel: () => void;
  capturePrisoner: () => void;
  releasePrisoner: () => void;
  executePrisoner: () => void;
  attemptAdminLogin: (password: string) => boolean;
