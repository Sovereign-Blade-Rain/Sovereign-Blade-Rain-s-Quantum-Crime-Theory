...
export interface WorldPreset {
  ...
  description: string;
  thumbnail?: string;
  state: any; // The session state object
}
...
export type PlayerRole = 'pilot' | 'passenger' | 'prisoner';
export type PrisonerStatus = 'imprisoned' | 'hidden' | 'escaped' | 'dead';
...
export interface RolePlayState {
    ...
    hasMasterPlanAccess: boolean;
    employeeRank: number; // 1 is highest, 100 is lowest
}
